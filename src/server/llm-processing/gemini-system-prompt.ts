...
export const GEMINI_CV_OPTIMIZER_SYSTEM_PROMPT = normalizePromptLines([
	...
	'16. If the user provides target positions, prioritize relevance and keyword alignment for those positions only.',
	'17. If target positions are unrelated to each other, keep the CV coherent and avoid forcing incompatible narratives.',
	'18. Si es relevante para el puesto y/o sector del usuario, sugiere añadir redes sociales (LinkedIn, Github, etc) y links a portfolios, siempre y cuando sea aceptable y relevante para un proceso de reclutamiento.'
]);
